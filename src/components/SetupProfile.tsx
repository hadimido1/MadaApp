    ...
    <div className="min-h-screen w-full bg-black flex items-center justify-center p-6 relative overflow-hidden" dir="rtl">
      <div className="w-full max-w-sm relative z-10 flex flex-col items-center">
        ...
        <form onSubmit={handleSubmit} className="w-full space-y-4">
          <div className="bg-white/[0.03] border border-white/10 rounded-[24px] p-2 backdrop-blur-xl shadow-2xl flex flex-col gap-2">
            <div className="px-5 pt-4 pb-2">
              <label className="block text-[10px] font-black text-gray-500 mb-2 uppercase tracking-wide">الاسم الكامل</label>
              <input 
                type="text" 
                value={name}
            ...
            <div className="px-5 pb-2 pt-2">
              <label className="block text-[10px] font-black text-gray-500 mb-2 uppercase tracking-wide">العمر</label>
              <input 
                type="number" 
                value={age}
            ...
            <div className="h-[1px] w-full bg-white/5"></div>
            <div className="px-5 pb-2 pt-2">
              <label className="block text-[10px] font-black text-gray-500 mb-2 uppercase tracking-wide">البلد</label>
              <input 
                type="text" 
                value={country}
            ...
            <div className="px-5 pb-4 pt-2">
              <label className="block text-[10px] font-black text-blue-500 mb-2 uppercase tracking-wide">رمز فك التشفير للبطاقة (PIN)</label>
              <input 
                type="password" 
                value={pin}
          ...
          >
            {loading ? 'جاري الإصدار...' : 'إصدار البطاقة'}
          </button>
        </form>
      </div>
    </div>
